...
import { Card, Row, Col, Button, Space, Typography, Tag, Spin, Divider, Table } from 'antd'
import {
  RocketOutlined,
  ScanOutlined,
  BarChartOutlined,
...
export const MktOverviewPage: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Title level={3}>营销提效概览</Title>
      <Text type="secondary" className={styles.desc}>
        从卖点提炼到内容生成、合规检测、多渠道发布、转化追踪，一站式营销工作流
      </Text>
      ...
      <Card title="营销全链路" className={styles.card} size="small">
        <ProcessFlow
          steps={[
            ...
            { key: 'track', label: '转化追踪', route: '/conversion/dashboard', status: 'pending', icon: <BarChartOutlined />, description: 'CTR/CVR 效果归因分析' },
          ...
          <Card title="效果归因看板" className={styles.card}>
            <div className={styles.attribution}>
              ...
              <div className={styles.attrItem}>
                ...
                <Text type="secondary" className={styles.attrNote}>占总成单 38%</Text>
              </div>
            </div>
          </Card>
        </Col>
