...
const sourcePageConfig: Record<string, { title: string; subtitle: string; mainImage: string; banner: string; cta: string; highlights: string[] }> = {
  direct: {
    ...
    mainImage: 'https://via.placeholder.com/600x400/1890ff/fff?text=FX3U+PLC',
    banner: 'https://via.placeholder.com/1200x200/001529/fff?text=官方推荐+工业自动化首选',
    cta: '立即询价',
  ...
  search: {
    ...
    mainImage: 'https://via.placeholder.com/600x400/52c41a/fff?text=PLC+控制器',
    banner: 'https://via.placeholder.com/1200x200/096dd9/fff?text=热门搜索+PLC控制器 全国包邮',
    cta: '查看报价',
  ...
  social: {
    ...
    mainImage: 'https://via.placeholder.com/600x400/722ed1/fff?text=自动化神器',
    banner: 'https://via.placeholder.com/1200x200/531dab/fff?text=爆款热卖+10000+工厂信赖',
    cta: '立即抢购',
  ...
  ad: {
    ...
    mainImage: 'https://via.placeholder.com/600x400/faad14/fff?text=限时特惠',
    banner: 'https://via.placeholder.com/1200x200/d48806/fff?text=限时优惠+立省15% 错过等一年',
    cta: '抢占名额',
